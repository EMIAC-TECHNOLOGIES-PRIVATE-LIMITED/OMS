  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 absolute top-14 z-100 hidden  w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex  flex-1 flex-col bg-white dark:bg-slate-950",
