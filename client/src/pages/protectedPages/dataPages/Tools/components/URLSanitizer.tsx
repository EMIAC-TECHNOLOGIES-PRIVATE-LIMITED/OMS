...
function URLSanitizer() {
    ...
    const sanitizeURLs = () => {
        ...
        urls.forEach(url => {
            try {
                ...
                if (domainPattern.test(cleanDomain)) {
                    // Improved logic for www prefix
                    const shouldAddWww = shouldAddWwwPrefix(cleanDomain);
        ...
        // Helper function to determine if www should be added
        function shouldAddWwwPrefix(domain: string): boolean {
            // Always add www unless the domain already starts with www
